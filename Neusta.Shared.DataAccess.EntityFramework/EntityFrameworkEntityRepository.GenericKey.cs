namespace Neusta.Shared.DataAccess.EntityFramework
{
	...
	[PublicAPI]
	public abstract class EntityFrameworkEntityRepository<TDataContext, TEntity, TKey> : BaseEntityRepository<TDataContext, TEntity, TKey>, IEntityFrameworkEntityRepository<TDataContext, TEntity, TKey>
		where TDataContext : IEntityFrameworkDataContext<TDataContext>
		where TEntity : class, IEntityWithID<TKey>
		where TKey : struct, IEquatable<TKey>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="EntityFrameworkEntityRepository{TDataContext, TEntity, TKey}"/> class.
		/// </summary>
